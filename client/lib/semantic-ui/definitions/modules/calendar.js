...
(function ($, window, document, undefined) {
  ...
  $.fn.calendar.settings = {
    ...
    isChinese:false,       // year is the first in chinese date and it is defined myself
    ...
    formatter: {
      ...
      date: function (date, settings) {
        ...
        var day = settings.isChinese ? date.getDate()+'日' : date.getDate();
        var month = settings.text.months[date.getMonth()];
        ...
        return settings.type === 'year' ? year :
          ...
          settings.isChinese ? year+', ' + month + day:
